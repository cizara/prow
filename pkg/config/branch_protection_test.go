	...
	testCases := []struct {
		...
		},
		{
			...
			config: Config{
				ProwConfig: ProwConfig{
					BranchProtection: BranchProtection{
						AllowDisabledPolicies: utilpointer.To(true),
						Policy: Policy{
							Protect: yes,
							Restrictions: &Restrictions{
								Teams: []string{"oncall"},
		...
		},
		{
			...
			config: Config{
				ProwConfig: ProwConfig{
					BranchProtection: BranchProtection{
						ProtectTested: utilpointer.To(true),
						Orgs: map[string]Org{
							"org": {},
						},
					},
		...
		},
		{
			...
			config: Config{
				ProwConfig: ProwConfig{
					BranchProtection: BranchProtection{
						ProtectTested:                utilpointer.To(true),
						ProtectReposWithOptionalJobs: utilpointer.To(true),
						Orgs: map[string]Org{
							"org": {},
						},
					},
		...
		},
		{
			...
			config: Config{
				ProwConfig: ProwConfig{
					BranchProtection: BranchProtection{
						AllowDisabledJobPolicies: utilpointer.To(true),
						ProtectTested:            utilpointer.To(true),
						Orgs: map[string]Org{
							"org": {
								Repos: map[string]Repo{
